    ...
    <div class="container indigo lighten-4 deep-orange-text col s12">
        ...
        <div class="row  black-text">
            <div class="input-field col s8">
                <h5>ID: <?php echo $equipamento->getID() ?></h5>
            ...
            <div class="brown lighten-3 center col s12">
                <br>
                <button class="waves-effect waves-light btn green" type="button"                     onclick="JavaScript:location.href='formEquipamento.php'"><i class="material-icons">add</i>
                </button>

                <button class="waves-effect waves-light btn orange" type="button" 
                onclick="JavaScript:location.href='formEdtEqpto.php?id=' + '<?php echo $equipamento->getID();?>'"><i class="material-icons">edit</i>
                </button>
